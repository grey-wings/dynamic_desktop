...
"""注意：如果没有托盘中没有出现图标，检查相应路径下是否有ico文件！！！！！！"""
...
class DdMainUI(QMainWindow, Ui_MainWindow):
    ...
    def mini(self):
        # Qt.SplashScreen没有任务栏图标
        self.setWindowFlags(Qt.SplashScreen | Qt.FramelessWindowHint | Qt.WindowSystemMenuHint)
        self.stop_preview()
        self.mini_icon.show()  # 用这个代替showMinimized可以防止最小化后保留一个窗口栏
        # self.showMinimized()
        self.close()
    ...
    def play(self):
        ...
        try:
            ...
            if isDebug:
                ...
                os_system(r'start ../../../DdPlay/dist/DdPlay/DdPlay.exe')
            # 执行命令行
        except:
            pass
        self.stop_preview()
